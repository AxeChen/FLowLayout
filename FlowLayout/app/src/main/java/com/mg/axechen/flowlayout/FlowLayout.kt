...
/**
 * Created by AxeChen on 2017/11/1.
 * 流式布局
 */
class FlowLayout : ViewGroup {

    // 保存每行多少个多少行
    var viewLines: ArrayList<ArrayList<View>> = ArrayList()
    // 保存高度
    var totalHeight: ArrayList<Int> = ArrayList()
     ...
     * 代码添加items
     */
    fun addItems(views: ArrayList<View>) {
